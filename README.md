...
`sources/` 配下のファイルは各 Wikidot ページのページソースを保存したものです。
[Creative Commons Attribution-ShareAlike 3.0 License](https://creativecommons.org/licenses/by-sa/3.0/) が適用されます。

| ファイル | 出典 |
|---|---|
| `sources/jp/fragment-basic.txt` | http://scp-jp.wikidot.com/fragment:tag-list-basic |
| `sources/jp/fragment-series.txt` | http://scp-jp.wikidot.com/fragment:tag-list-series |
| `sources/jp/fragment-universe.txt` | http://scp-jp.wikidot.com/fragment:tag-list-universe |
| `sources/jp/fragment-event.txt` | http://scp-jp.wikidot.com/fragment:tag-list-event |
| `sources/en/tag-list.txt` | https://05command.wikidot.com/tech-hub-tag-list |

  ...
  <body>
    <main class="shell">
      ...
      <section class="layout">
        ...
        <section class="panel" aria-label="タグ詳細">
          <div class="panel-header">
          ...
          <div class="controls">
            <div class="control-row">
              ...
              <div class="field">
                ...
                <select id="sortSelect">
                  ...
                  <option value="unhandled-first">未収録優先</option>
            ...
            <div class="quick-actions">
              ...
              <button class="command" id="unhandledButton" type="button">未収録のみ</button>
    ...
    <script>
      ...
      function branchTranslatorHandledCount(branch) {
        return (
          branch.tag_count -
          (branch.status_counts.unhandled || 0) -
          (branch.status_counts.jp_unused_no_single_replacement || 0)
        );
      }
      ...
      function renderMetrics() {
        ...
        const cards = [
          ["支部", branchCount, "コーパス由来の翻訳元"],
          ["タグ", summary.total, `${formatNumber(summary.pages)}ページ出現`],
          ["JPリスト内", summary.jpListHandled, formatPercent(summary.jpListHandled, summary.total)],
          ["未収録", summary.unhandled, formatPercent(summary.unhandled, summary.total)],
        ];
            ...
            return `
              <button class="branch-row${active}" type="button" data-branch="${escapeHtml(branch.branch)}">
                ...
                <span class="branch-meta">
                  ...
                  <span class="branch-caption">${formatNumber(handled)} / ${formatNumber(branch.tag_count)} 翻訳側対応</span>
                </span>
      ...
      function renderDetail(rows) {
        ...
        els.donutValue.textContent = formatPercent(summary.translatorHandled, summary.total);
        els.donutText.textContent = "対応済み";
        ...
        const insightItems = [
          ...
          ["未収録最多", topUnhandled ? topUnhandled.tag : "-", topUnhandled ? `${topUnhandled.branch} / ${formatNumber(topUnhandled.page_count)}ページ` : ""],
          ...
          .map((row) => {
            ...
            return `
              <tr>
                ...
                <td>${source ? escapeHtml(source) : '<span class="tag-detail">-</span>'}</td>
      ...
      function exportTsv() {
        ...
        const headers = ["branch", "tag", "status", "jp_tag", "replacement", "page_count", "rank", "sample_slugs"];
